...
__sect_help__ = f"""
\n#宗门指令：
\n><qqbot-cmd-input text=\"我的宗门\" show=\"我的宗门\" reference=\"false\" />:查看当前所处宗门信息
\n><qqbot-cmd-input text=\"创建宗门\" show=\"创建宗门\" reference=\"false\" />:创建宗门，需求：{XiuConfig().sect_create_cost}灵石，需求境界{XiuConfig().sect_min_level}
\n><qqbot-cmd-input text=\"加入宗门\" show=\"加入宗门 宗门编号\" reference=\"false\" />:加入一个宗门,需要带上宗门编号
\n><qqbot-cmd-input text=\"宗门捐献\" show=\"宗门捐献\" reference=\"false\" />:建设宗门，提高宗门建设度，每{config["等级建设度"]}建设度会提高1级攻击修炼等级上限
\n><qqbot-cmd-input text=\"退出宗门\" show=\"退出宗门\" reference=\"false\" />:退出当前宗门
\n><qqbot-cmd-input text=\"升级攻击修炼\" show=\"升级攻击修炼\" reference=\"false\" />:升级道友的攻击修炼等级。
\n><qqbot-cmd-input text=\"宗门列表\" show=\"宗门列表\" reference=\"false\" />:查看所有宗门列表
\n><qqbot-cmd-input text=\"宗门任务接取\" show=\"宗门任务接取\" reference=\"false\" />:接取宗门任务，可以增加宗门建设度和资材，每日上限：{config["每日宗门任务次上限"]}次
\n><qqbot-cmd-input text=\"宗门任务完成\" show=\"宗门任务完成\" reference=\"false\" />:完成所接取的宗门任务，完成间隔时间：{config["宗门任务完成cd"]}秒
\n><qqbot-cmd-input text=\"宗门任务刷新\" show=\"宗门任务刷新\" reference=\"false\" />宗门任务刷新:刷新当前所接取的宗门任务，刷新间隔时间：{config["宗门任务刷新cd"]}秒
\n><qqbot-cmd-input text=\"学习宗门功法\" show=\"宗门功法\" reference=\"false\" />、<qqbot-cmd-input text=\"学习宗门神通\" show=\"宗门神通\" reference=\"false\" />学习:宗门成员可消耗宗门资材来学习宗门功法或者神通，后接功法名称
\n><qqbot-cmd-input text=\"宗门功法查看\" show=\"宗门功法查看\" reference=\"false\" />:查看当前宗门已有的功法
\n><qqbot-cmd-input text=\"宗门成员查看\" show=\"宗门成员查看\" reference=\"false\" />:查看所在宗门的成员信息
\n><qqbot-cmd-input text=\"宗门丹药领取\" show=\"宗门丹药领取\" reference=\"false\" />:领取宗门丹药

\n<qqbot-cmd-input text=\"宗主指令\" show=\"宗主指令\" reference=\"false\" />:查看宗主功能菜单
""".strip()

__sect_helps__ = f"""
\n#宗主指令：
\n><qqbot-cmd-input text=\"创建宗门\" show=\"创建宗门\" reference=\"false\" />:创建宗门，需求：{XiuConfig().sect_create_cost}灵石，需求境界{XiuConfig().sect_min_level}
\n><qqbot-cmd-input text=\"宗门职位变更\" show=\"宗门职位变更\" reference=\"false\" />:宗主可以改变宗门成员的职位等级【0 1 2 3 4】分别对应【宗主 长老 亲传 内门 外门】(例如:宗门职位变更 道号 2)
\n><qqbot-cmd-input text=\"宗门改名\" show=\"宗门改名\" reference=\"false\" />:宗主可以消耗宗门灵石改变宗门名称
\n><qqbot-cmd-input text=\"宗训修改\" show=\"宗训修改\" reference=\"false\" />:宗主可以消耗宗门灵石添加宗训，注意不要违规。灵梦有权修改各宗宗训。
\n><qqbot-cmd-input text=\"踢出宗门\" show=\"踢出宗门\" reference=\"false\" />:踢出对应宗门成员,后面加上道号
\n><qqbot-cmd-input text=\"宗主传位\" show=\"宗主传位\" reference=\"false\" />:宗主可以传位宗门成员
\n><qqbot-cmd-input text=\"宗门丹房建设\" show=\"宗门丹房建设\" reference=\"false\" />:建设宗门丹房，可以让每个宗门成员每日领取丹药
\n><qqbot-cmd-input text=\"宗门功法搜寻\" show=\"宗门功法\" reference=\"false\" />、<qqbot-cmd-input text=\"宗门神通搜寻\" show=\"宗门神通\" reference=\"false\" />搜索:宗主可消耗宗门资材和宗门灵石来搜寻功法或者神通
""".strip()
...
async def sect_help_(bot: Bot, event: GroupMessageEvent, session_id: int = CommandObjectID()):
    ...
    if session_id in cache_help:
        ...
        buttons = [
            [(2, '创建宗门', '创建宗门', True), (2, '宗门改名', '宗门改名', False)],            
            [(2, '职位变更', '宗门职位变更', False), (2, '踢出宗门', '踢出宗门', False)],
            [(2, '丹房建设', '宗门丹房建设', True), (2, '成员查看', '宗门成员查看', True)],   
            [(2, '宗门功法搜寻', '宗门功法搜寻', True), (2, '宗门神通搜寻', '宗门神通搜寻', True)],             
        ]
...
async def sect_help_(bot: Bot, event: GroupMessageEvent, session_id: int = CommandObjectID()):
    ...
    if session_id in cache_help:
        ...
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入宗门', '加入宗门', False), (2, '宗门列表', '宗门列表', True)],            
        ]
        data = await markdown(params_items, buttons)
        await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
        await sect_help.finish()
    ...
    if sect_id:
        ...
        if sect_position == owner_position:
            ...
            if elixir_room_level_up_use_stone_cost > int(sect_info['sect_used_stone']):
                ...
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '宗门丹房建设', '宗门丹房建设', True)],        
                ]
                data = await markdown(params_items, buttons)
                await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data}))
                await sect_elixir_room_make.finish()
        else:
            msg = f"道友非宗主，无法使用，难道有自立之心？！"
            params_items = [('msg', msg)]
            buttons = [
                [(2, '创建宗门', '创建宗门', True)],        
            ]
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得胡闹！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
        data = await markdown(params_items, buttons)
        await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
        await sect_elixir_room_make.finish()
    ...
    if sect_id:
        ...
        if sect_position == 4:
            ...
            if int(sect_info['elixir_room_level']) == 1:
                msg = f"道友成功领取到丹药:渡厄丹！"
                sql_message.send_back(user_info['user_id'], 1999, "渡厄丹", "丹药", 1, 0)  # 1级丹房送1个渡厄丹
                ...
                if not give_elixir_id_list:  # 没有合适的ID，全部给渡厄丹
                    ...
                    sql_message.send_back(user_info['user_id'], 1999, "渡厄丹", "丹药", 2, 0)  # 送1个渡厄丹
                    sql_message.update_user_sect_elixir_get_num(user_info['user_id'])
                    params_items = [('msg', msg)]
                    buttons = [
                        [(2, '宗门丹药领取', '宗门丹药领取', True)],      
                ...
                sql_message.send_back(user_info['user_id'], 1999, "渡厄丹", "丹药", 1, 0)  # 送1个渡厄丹
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得偷领本宗秘传丹药！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
async def sect_buff_info_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        try:
            ...
            params_items = [('msg', msg)]
            buttons = [
                [(2, '学习宗门功法', '学习宗门功法', False), (2, '学习宗门神通', '学习宗门神通', False)],                
            ]
            data = await markdown(params_items, buttons)
            await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
            await sect_buff_info.finish()
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得偷看本宗秘籍！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
@sect_mainbuff_learn.handle(parameterless=[Cooldown(cd_time=10, at_sender=False)])
async def sect_mainbuff_learn_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if sect_id:
        sect_position = user_info['sect_position']
        if sect_position in {3, 4}:
            msg = f"""道友***{user_name}***所在宗门的职位为：{jsondata.sect_config_data()[f"{sect_position}"]["title"]}，不满足学习要求!"""
            params_items = [('msg', msg)]
            buttons = [
                [(2, '变更此道友职位', f'宗门职位变更 {user_name}', False)],                         
            ]
            data = await markdown(params_items, buttons)
            await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
            await sect_mainbuff_learn.finish()
            ...
            if msg not in get_mainname_list(sectmainbuffidlist):
                msg = f"本宗还没有该功法，请发送<qqbot-cmd-input text=\"宗门功法查看\" show=\"本宗有的功法\" reference=\"false\" />进行学习！"
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '学习宗门功法', '学习宗门功法', False), (2, '学习宗门神通', '学习宗门神通', False)],                        
                ]
            ...
            if sect_info['sect_materials'] >= materialscost:
                ...
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '学习此功法', f"学习宗门功法{mainbuff['name']}", False)]                       
                ]
                data = await markdown(params_items, buttons)
                await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
                await sect_mainbuff_learn.finish()
            else:
                msg = f"本次学习需要消耗{materialscost}宗门资材，本宗资材不够！"
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '我的宗门', '我的宗门', True)],                        
                ]
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得偷学本宗功法秘籍！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                         
        ]
...
async def sect_mainbuff_get_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得使用宗门搜索！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
    ...
    if sect_id:
        ...
        if sect_position == owner_position:
            ...
            if sect_info['sect_used_stone'] >= total_stone_cost and sect_info['sect_materials'] >= total_materials_cost:
                ...
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '宗门神通搜寻', '宗门神通搜寻', True), (2, '宗门功法搜寻', '宗门功法搜寻', True)],                        
                ]
                data = await markdown(params_items, buttons)
                await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
                await sect_secbuff_get.finish()
...
@sect_secbuff_learn.handle(parameterless=[Cooldown(cd_time=10, at_sender=False)])
async def sect_secbuff_learn_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if sect_id:
        ...
        if sect_position in {3, 4}:
            ...
            if msg not in get_secname_list(sectsecbuffidlist):
              #  msg = f"本宗还没有该神通，请发送本宗有的神通进行学习！"
                msg = f"本宗还没有该功法，请发送<qqbot-cmd-input text=\"宗门功法查看\" show=\"本宗有的神通\" reference=\"false\" />进行学习！"
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '学习宗门功法', '学习宗门功法', False), (2, '学习宗门神通', '学习宗门神通', False)],                        
                ]
            ...
            if sect_info['sect_materials'] >= materialscost:
                ...
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '学习此功法', f"学习宗门神通{secbuff['name']}", False)]                       
                ]
                data = await markdown(params_items, buttons)
                await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
                await sect_secbuff_learn.finish()
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得偷学本宗神通秘籍！！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
async def upatkpractice_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if sect_id:
        ...
        if sect_position in {3, 4}:
            msg = f"""道友***{user_name}***所在宗门的职位为：{jsondata.sect_config_data()[f"{sect_position}"]["title"]}，不满足使用资材的条件!"""
            params_items = [('msg', msg)]
            buttons = [
                [(2, '变更此道友职位', f'宗门职位变更 {user_name}', False)],                          
            ]
        ...
        params_items = [('msg', msg)]
        buttons = [
            [(2, '升级攻击修炼', f'升级攻击修炼', True)],                          
        ]
        data = await markdown(params_items, buttons)
        await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
        await upatkpractice.finish()
    else:
        msg = f"修炼逆天而行消耗巨大，道友乃一介散仙，还请加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />再进行修炼！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
async def sect_task_refresh_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得接取本宗任务！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
async def sect_list_(bot: Bot, event: GroupMessageEvent):
   ...
   # print(sect_lists_with_members) 
    ...
    # 页码范围限制
    page = max(0, min(page, page_num - 1))
    ...
    for sect in sect_lists_with_members[start_index:end_index]:
        sect_id, sect_name, sect_scale, user_name, member_count = sect
        msg += (f'\n><qqbot-cmd-input text=\"加入宗门{sect_id}\" show=\"编号{sect_id}\" reference=\"false\" /> {sect_name} <qqbot-cmd-input text=\"切磋 {user_name}\" show=\"{user_name}\" reference=\"false\" /> {sect_scale} {member_count}')
 ...
 #   msg += "\n".join(msg_list)
    ...
    # 显示当前页数和总页数
    if page_num > 1:
        msg += f'\n第({page + 1}/{page_num})页  <qqbot-cmd-input text=\"宗门列表\" show=\"跳转\" reference=\"false\" />'
  ...
  #  msgs = "\n\n".join(data_list)
    ...
    params_items = [('msg', msg)]
    button_list = [
        [(2, '加入宗门', '加入宗门', False), (2, '退出宗门', '退出宗门', False)],
        [(2, '我的宗门', '我的宗门', True)],
    ]

    if page > 0:
        button_list.append([(2, '上一页', f'宗门列表 {page}', True)])
    if page_num > page + 1:
        button_list.append([(2, '下一页', f'宗门列表 {page + 2}', True)])
...
async def sect_users_(bot: Bot, event: GroupMessageEvent):
    ...
    if user_info:
        ...
        if sect_id:
            if user_info.get('sect_position') == 4:
                msg = "道友职位权限不足，暂无法查看成员。"
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '宗门捐献', '宗门捐献', False)]
                ]
            ...
            msg_list.append(msg)
            i = 1
            for i, user in enumerate(userlist[start_index:end_index], start=start_index + 1):
                msg = f"""<qqbot-cmd-input text=\"踢出宗门 {user['user_name']}\" show=\"编号{i}\" reference=\"false\" /> <qqbot-cmd-input text=\"切磋 {user['user_name']}\" show=\"{user['user_name']}\" reference=\"false\" /> {user['level']} <qqbot-cmd-input text=\"宗门职位变更 {user['user_name']}\" show=\"{jsondata.sect_config_data()[f"{user['sect_position']}"]['title']}\" reference=\"false\" /> <qqbot-cmd-input text=\"宗门捐献\" show=\"{user['sect_contribution']}\" reference=\"false\" />"""
                msg_list.append(msg)
                i += 1
            if page_num > 1:
                msg_list.append(f'\n第({page + 1}/{page_num})页  <qqbot-cmd-input text=\"宗门成员查看\" show=\"跳转\" reference=\"false\" />')
                
            params_items = [('msg', "\n\n>".join(msg_list))]
            buttons = [
                [(2, '加入宗门', '加入宗门', False), (2, '宗门列表', '宗门列表', True)],
                [(2, '职位变更', '宗门职位变更', False), (2, '踢出宗门', '踢出宗门', False)],               
                [(2, '宗门帮助', '宗门帮助', True), (2, '宗主指令', '宗主指令', True)]
            ]
            if page > 0:
                buttons.append([(2, '⬅️上一页', f'宗门成员查看 {page}', True)])
          #  if page_num > 1:
          #      buttons.append([(2, f'⏺️跳转({page}/{page_num})', f'宗门成员查看', False)])
            if page + 1 < page_num:
                buttons.append([(2, '➡️下一页', f'宗门成员查看 {page + 2}', True)])
...
async def sect_task_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        msg = f"道友乃一介散仙，还未加入<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />，不得接取宗门任务！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
@sect_task_complete.handle(parameterless=[Cooldown(cd_time=config['宗门任务完成cd'],at_sender=False)])
async def sect_task_complete_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        msg = f"道友乃一介散仙，请<qqbot-cmd-input text=\"宗门列表\" show=\"加入宗门\" reference=\"false\" />后再完成任务，但你申请出门的机会我已经用小本本记下来了！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入本宗', f'加入宗门{sect_id}', False)],                          
        ]
...
async def sect_owner_change_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if not user_info['sect_id']:
        msg = f"道友乃一介散仙，还未加入一方<qqbot-cmd-input text=\"宗门列表\" show=\"宗门\" reference=\"false\" />。"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入宗门', '加入宗门', False)],                          
        ]
    ...
    msg_parts = msg.split()
    if len(msg_parts) >= 1:      
        pass_name = msg_parts[0]  # 提取道号
        user2_info = sql_message.get_user_info_with_name(pass_name)
    ...
    if give_qq:
        ...
        msg = f"请按照规范进行操作,例如:宗主传位 道号(需在自己管理下的宗门)升为宗主，自己则变为宗主下一等职位。"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '宗主传位', '宗主传位', False)],                 
        ]
...
@add_sect_memo.handle(parameterless=[Cooldown(cd_time=XiuConfig().sect_rename_cd * 60,at_sender=False)])
async def add_sect_memo_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    """宗训修改"""
    bot, send_group_id = await assign_bot(bot=bot, event=event)
    isUser, user_info, msg = check_user(event)
    if not isUser:
    ...
    if user_info['sect_position'] != owner_position:
        ...
        memomsg = args.extract_plain_text().strip() 
        update_sect_memo = memomsg 
        sect_id = user_info['sect_id']
        sect_info = sql_message.get_sect_info(sect_id)
        enabled_groups = JsonConfig().get_enabled_groups()
        len_sect_memo = len(update_sect_memo.encode('gbk'))

        if len_sect_memo > 50:
            msg = f"道友输入的宗训过长,请重新输入！"
            params_items = [('msg', msg)]
            buttons = [
                [(2, '宗训修改', '宗训修改', False)],                          
            ]
            ...
            msg = f"本宗宗门灵石储备不足，还需{number_to(XiuConfig().sect_rename_cost - sect_info['sect_used_stone'])}灵石!"
            params_items = [('msg', msg)]
            buttons = [
                [(2, '宗门捐献', '宗门捐献', False)],                          
            ]
            ...
            sql_message.update_sect_memo(sect_id, update_sect_memo)
            sql_message.update_sect_used_stone(sect_id, XiuConfig().sect_rename_cost, 2)
            msg = f"""
传宗门——【<qqbot-cmd-input text=\"加入宗门{sect_id}\" show=\"{sect_info['sect_name']}\" reference=\"false\" />】
...
async def sect_rename_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if user_info['sect_position'] != owner_position:
        ...
        if len_sect_name > 20:
            ...
            msg = f"已存在同名宗门(自己宗门名字一样的就不要改了),请重新选择！"
            params_items = [('msg', msg)]
            buttons = [
                [(2, '宗门改名', '宗门改名', False)],                          
            ]
...
传宗门——【<qqbot-cmd-input text=\"加入宗门{sect_id}\" show=\"{sect_info['sect_name']}\" reference=\"false\" />】
宗主***{user_info['user_name']}***法旨:
宗门改名为【<qqbot-cmd-input text=\"我的宗门\" show=\"{update_sect_name}\" reference=\"false\" />】！
星斗更迭，法器灵通，神光熠熠。
愿同门共沐神光，共护宗门千世荣光！
青天无云，道韵长存，灵气飘然。
愿同门同心同德，共铸宗门万世辉煌！"""
...
async def create_sect_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if (list_level_all.index(level) < list_level_all.index(XiuConfig().sect_min_level)):
        msg = f"创建宗门要求:创建者境界最低要求为{XiuConfig().sect_min_level}，道友还需多多修炼才是！"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '修炼', '修炼', True)],                        
        ]
        ...
        sect_info = sql_message.get_sect_info_by_id(user_info['sect_id'])
        msg = f"道友已经加入了宗门:{sect_info['sect_name']}，无法再<qqbot-cmd-input text=\"创建宗门\" show=\"创建宗门\" reference=\"false\" />。"
        params_items = [('msg', msg)]
        buttons = [
            [(2, '退出宗门', '退出宗门', False)],                        
        ]
...
async def sect_kick_out_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    msg_parts = msg.split()
    if len(msg_parts) >= 1:      
        kick_name = msg_parts[0]  # 提取道号
        user2_info = sql_message.get_user_info_with_name(kick_name)
        give_qq = user2_info['user_id']
    ...
    if give_qq:
        if give_qq == user_id:
           ...
           # 调用 markdown 函数生成数据
            ...
            if give_user['sect_id'] == user_info['sect_id']:
                ...
                if user_info['sect_position'] <= idx_position:
                    if give_user['sect_position'] <= user_info['sect_position']:
                       ...
                       # 调用 markdown 函数生成数据
                        ...
                        msg = f"""传{jsondata.sect_config_data()[f"{user_info['sect_position']}"]['title']}***{user_info['user_name']}***法旨，即日起道友***{give_user['user_name']}***被{sect_info['sect_name']}除名"""
                        params_items = [('msg', msg)]               
                        buttons = [
                            [(2, '踢出宗门', '踢出宗门', False)],            
                        ]
                ...
                params_items = [('msg', msg)]               
                buttons = [
                    [(2, '踢出宗门', '踢出宗门', False), (2, '成员查看', '宗门成员查看', False)],            
                ]
               # 调用 markdown 函数生成数据
                data = await markdown(params_items, buttons)
                await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data}))
        ...
        msg = f"请按照规范进行操作,例如:踢出宗门 道号,将道友(需在自己管理下的宗门）踢出宗门"
        params_items = [('msg', msg)]               
        buttons = [
            [(2, '踢出宗门', '踢出宗门', False)],            
        ]
...
async def sect_donate_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if len(donate_num) > 0:
        if int(donate_num[0]) > user_info['stone']:
            msg = f"道友的灵石数量小于欲捐献数量{int(donate_num[0])}，请检查背包。"
            params_items = [('msg', msg)]               
            buttons = [
                [(2, '宗门捐献', '宗门捐献', False)],            
            ]
...
async def sect_position_update_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
    ...
    if give_qq:
        if give_qq == user_id:
           ...
           # 调用 markdown 函数生成数据
            ...
            if len(position_num) > 0 and position_num[0] in list(jsondata.sect_config_data().keys()):
                ...
                user_name = user_info['user_name']
                sect_info = sql_message.get_sect_info(sect_id) 
                elders_list = sql_message.get_users_by_sect_and_position(sect_id, sect_position=1)
                elder_count = len(elders_list) 
                protectors_list = sql_message.get_users_by_sect_and_position(sect_id, sect_position=2)
                protector_count = len(protectors_list)                
                elder_limit = config['宗门丹房参数']['elixir_room_level'][str(sect_info['elixir_room_level'])]['position_limits']['长老']
                protector_limit = config['宗门丹房参数']['elixir_room_level'][str(sect_info['elixir_room_level'])]['position_limits']['护法']
                if position_num[0] == '1':  # 对应长老
                    if elder_count >= elder_limit:
                        msg = f"当前宗门仅允许最多 {elder_limit} 位长老，无法再增加长老。"
                        params_items = [('msg', msg)]               
                        buttons = [
                            [(2, '宗门职位变更', '宗门职位变更', False)],            
                        ]
                        ...
                        await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data}))
                        await sect_position_update.finish()
                elif position_num[0] == '2':  # 对应护法
                    if protector_count >= protector_limit:
                        msg = f"当前宗门仅允许最多 {protector_limit} 位护法，无法再增加护法。"
                        params_items = [('msg', msg)]               
                        buttons = [
                            [(2, '宗门职位变更', '宗门职位变更', False)],            
                        ]
                ...
                if give_user['sect_id'] == user_info['sect_id'] and give_user['sect_position'] > user_info['sect_position']:
                    if int(position_num[0]) > user_info['sect_position']:
                        ...
                        msg = f"""传{jsondata.sect_config_data()[f"{user_info['sect_position']}"]['title']}***{user_info['user_name']}***法旨：即日起道友***{give_user['user_name']}***为本宗{jsondata.sect_config_data()[f"{int(position_num[0])}"]['title']}"""
                        params_items = [('msg', msg)]               
                        buttons = [
                            [(2, '宗门职位变更', '宗门职位变更', False)],            
                        ]
        ...
        msg = f"""请按照规范进行操作,例如:宗门职位变更 道号 2,将某道友(需在自己管理下的宗门)的变更为{jsondata.sect_config_data().get('2', {'title': '没有找到2品阶'})['title']}"""
        params_items = [('msg', msg)]               
        buttons = [
            [(2, '宗门职位变更', '宗门职位变更', False)],            
        ]
...
async def join_sect_(bot: Bot, event: GroupMessageEvent, args: Message = CommandArg()):
  ...
  #  elixir_room_config = config['宗门丹房参数']
    if not isUser:
        msg = f"只见守山弟子拦在跟前，道：凡人，回去吧，仙途难入，莫要自误！"
        params_items = [('msg', msg)]               
        buttons = [
            [(2, '我要修仙', '我要修仙 ', True)],            
        ]
    ...
    if not user_info['sect_id']:
        ...
        if not sect_no.isdigit():
            msg = f"道友想申请加入哪个宗门？请发送宗门列表查看!"
        elif int(sect_no) not in sects_all:
            msg = f"道友申请加入的宗门编号似乎有误，未在宗门名录上发现!"
        else:
            # 获取宗门信息
            new_sect = sql_message.get_sect_info_by_id(int(sect_no))
            
            # 获取宗门所有成员
            members = sql_message.get_all_users_by_sect_id(int(sect_no))
            current_member_count = len(members)  # 直接计算当前成员数量
            
            # 获取宗门等级限制的成员数量上限
          #  elixir_room_level_up_config = elixir_room_config['elixir_room_level']
           # member_limit = elixir_room_level_up_config[str(new_sect['elixir_room_level'])]['member_limit']
            member_limit = config['宗门丹房参数']['elixir_room_level'][str(new_sect['elixir_room_level'])]['member_limit']
           # print(config['宗门丹房参数']['elixir_room_level'])
           # print(new_sect['elixir_room_level'])
            if current_member_count >= member_limit:
                msg = f"本宗弟子已满（{current_member_count}/{member_limit}），道友请回吧。"
                params_items = [('msg', msg)]
                buttons = [
                    [(2, '加入宗门', '加入宗门 ', False)],           
                ]    
                ...
                msg = f"欢迎【**{user_info['user_name']}**】师弟入我宗门：{new_sect['sect_name']}，共参天道。"
    else:
...
async def my_sect_(bot: Bot, event: GroupMessageEvent):
    ...
    if sect_id:
        ...
        elder_count = len(elders_list) 
        protectors_list = sql_message.get_users_by_sect_and_position(sect_id, sect_position=2)
        neimen_list = sql_message.get_users_by_sect_and_position(sect_id, sect_position=3)
        neimen_count = len(neimen_list)
        waimen_list = sql_message.get_users_by_sect_and_position(sect_id, sect_position=4)
        waimen_count = len(waimen_list)
        protector_count = len(protectors_list) 
        elder_limit = config['宗门丹房参数']['elixir_room_level'][str(sect_info['elixir_room_level'])]['position_limits']['长老']
        protector_limit = config['宗门丹房参数']['elixir_room_level'][str(sect_info['elixir_room_level'])]['position_limits']['护法']     
        ...
        msg = f"""
<qqbot-cmd-input text=\"切磋 {user_name}\" show=\"{user_name}\" reference=\"false\" />所在宗门
宗门名讳：<qqbot-cmd-input text=\"加入宗门{sect_id}\" show=\"{sect_info['sect_name']}\" reference=\"false\" />  |  宗门编号：{sect_id}
宗   主：<qqbot-cmd-input text=\"切磋 {sql_message.get_user_info_with_id(sect_info['sect_owner'])['user_name']}\" show=\"{sql_message.get_user_info_with_id(sect_info['sect_owner'])['user_name']}\" reference=\"false\" />
道友职位：<qqbot-cmd-input text=\"宗门职位变更\" show=\"{jsondata.sect_config_data()[f"{sect_position}"]['title']} {user_name}\" reference=\"false\" /> 
宗门建设度：<qqbot-cmd-input text=\"宗门丹房建设\" show=\"{sect_info['sect_scale']}\" reference=\"false\" />
...
宗门贡献度：<qqbot-cmd-input text=\"宗门捐献\" show=\"{number_to(user_info['sect_contribution'])}\" reference=\"false\" />
...
"""
        if sect_position == owner_position:
            ...
            params_items = [('msg', msg)]
            buttons = [
                [(2, '宗门改名', '宗门改名', False), (2, '宗训修改', '宗训修改', False), (2, '踢出宗门', '踢出宗门', False)],            
                [(2, '宗门职位变更', '宗门职位变更', False), (2, '宗主传位', '宗主传位', False)],
                [(2, '宗门功法搜寻', '宗门功法搜寻', True), (2, '宗门神通搜寻', '宗门神通搜寻', True)],    
                [(2, '宗门丹房建设', '宗门丹房建设', True), (2, '宗门成员查看', '宗门成员查看', True)],                
            ]   
            data = await markdown(params_items, buttons)
            await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
            await my_sect.finish()
            ...
            params_items = [('msg', msg)]
            buttons = [
                [(2, '宗门捐献', '宗门捐献', False), (2, '宗门任务刷新', '宗门任务刷新', True)],            
                [(2, '宗门任务接取', '宗门任务接取', True), (2, '宗门任务完成', '宗门任务完成', True)],
        ...
        params_items = [('msg', msg)]
        buttons = [
            [(2, '加入宗门', '加入宗门', False), (2, '创建宗门', '创建宗门', True)],            
            [(2, '宗门帮助', '宗门帮助', True)],
        ]   
        data = await markdown(params_items, buttons)
        await bot.send_group_msg(group_id=int(send_group_id), message=MessageSegment("markdown", {"data": data})) 
