...
def convert_rank(rank_name):
    ...
    ranks = [
        '江湖好手', # 87
        '搬血境初期', '搬血境中期', '搬血境圆满', # 84
        '洞天境初期', '洞天境中期', '洞天境圆满', # 81
        '化灵境初期', '化灵境中期', '化灵境圆满', #78
        '铭纹境初期', '铭纹境中期', '铭纹境圆满', #75
        '列阵境初期', '列阵境中期', '列阵境圆满', #72
        '尊者境初期', '尊者境中期', '尊者境圆满', # 69
        '神火境初期', '神火境中期', '神火境圆满',#66
        '真一境初期', '真一境中期', '真一境圆满',#63
        '圣祭境初期', '圣祭境中期', '圣祭境圆满',#60
        '天神境初期', '天神境中期', '天神境圆满', #57
        '虚道境初期', '虚道境中期', '虚道境圆满', #54
        '斩我境初期', '斩我境中期', '斩我境圆满',#51
        '遁一境初期', '遁一境中期', '遁一境圆满',#48
        '至尊境初期', '至尊境中期', '至尊境圆满', # 45
        '真仙境初期', '真仙境中期', '真仙境圆满',#42
        '仙王境初期', '仙王境中期', '仙王境圆满',#39
        '准帝境初期', '准帝境中期', '准帝境圆满',#36
        '仙帝境初期', '仙帝境中期', '仙帝境圆满',#33
        '祭道境初期', '祭道境中期', '祭道境圆满',  #30
        '造化境初期', '造化境中期', '造化境圆满', #27
        '窥涅境初期', '窥涅境中期', '窥涅境圆满',#24
        '净涅境初期', '净涅境中期', '净涅境圆满',#21
        '空涅境初期', '空涅境中期', '空涅境圆满',#18
        '碎涅境初期', '碎涅境中期', '碎涅境圆满', #15
        '空灵境初期', '空灵境中期', '空灵境圆满', #12
        '空玄境初期', '空玄境中期', '空玄境圆满', #9
        '空劫境初期', '空劫境中期', '空劫境圆满', #6
        '踏天境初期', '踏天境中期', '踏天境圆满',  #3
        '无上境初期', '无上境中期', '无上境圆满' #0
...
class XiuConfig:
    def __init__(self):
       ...
       # self.sql_bank = ["user_id", "savestone", "savetime", "banklevel"]
        ...
        self.level_up_cd = 0.05  # 突破CD(分钟)
        self.closing_exp = 20  # 闭关每分钟获取的修为
        ...
        self.gift_min_level = "洞天境初期" # 领取礼包最低境界        
        self.sect_create_cost = 50000000 # 创建宗门消耗
        self.sect_rename_cost = 50000000 # 宗门改名消耗
        self.sect_rename_cd = 1 # 宗门改名cd/天
        self.auto_change_sect_owner_cd = 14 # 自动换长时间不玩宗主cd/天
